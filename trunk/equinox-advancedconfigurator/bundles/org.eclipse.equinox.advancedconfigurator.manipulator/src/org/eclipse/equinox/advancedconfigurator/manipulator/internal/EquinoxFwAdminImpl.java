...
public class EquinoxFwAdminImpl implements FrameworkAdmin {
	...
	public Manipulator getManipulator() {
		return new AdvancedEquinoxManipulatorImpl(context, this, platformAdmin, startLevelService, false);
	}

	public Manipulator getRunningManipulator() {
		if (!this.runningFw)
			return null;
		return new AdvancedEquinoxManipulatorImpl(context, this, platformAdmin, startLevelService, true);
	}
	...
	private void loadConfiguratorManipulator(String configuratorManipulatorFactoryName) throws InstantiationException, IllegalAccessException,
